            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="category" class="form-select @error('category') is-invalid @enderror">
                        <option value="connectivity" {{ old('category', $complaint->category) == 'connectivity' ? 'selected' : '' }}>Connectivity</option>
                        <option value="speed" {{ old('category', $complaint->category) == 'speed' ? 'selected' : '' }}>Speed</option>
                        <option value="billing" {{ old('category', $complaint->category) == 'billing' ? 'selected' : '' }}>Billing</option>
                        <option value="equipment" {{ old('category', $complaint->category) == 'equipment' ? 'selected' : '' }}>Equipment</option>
